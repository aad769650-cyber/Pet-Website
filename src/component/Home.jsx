    ...
    return(
        ...
        <section className="Home">
            <div className="home-container ">
                <div className="homeInfo flex1">
                    <h1 className="heading">Your trusted companion in pet adoption and care</h1>
                    <div className="para"> <p>Find your perfect furry friend and give them a forever home.</p></div>
                    <button className="homeBtn flex-center"><NavLink to={"/contact"}>Join Us</NavLink> <FaArrowRightLong className="homeIcon"/></button>
